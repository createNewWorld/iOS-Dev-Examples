...
- (void)drawRect:(CGRect)rect {
    ...
    //58,92,109 #3a5c6d
    [[UIColor colorWithRed:(58/255.0f) green:(92/255.0f) blue:(109/255.0f) alpha:1.0f] setStroke]; //设置描边颜色
...
{
    NSString *progressStr = [NSString stringWithFormat:@"%ld/%ld", count, self.totalCount];
